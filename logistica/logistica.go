...
func sendToQueue(body string) {
	conn, err := amqp.Dial("amqp://guest:guest@dist038:5672/")
	if err != nil {
...
func (s *Server) InitCaravanas() {
	...
	s.caravanas = map[string]*Caravana{
		"Ostronitas":  {Estado: "Disponible", Cliente: s.connectCaravana("dist039:50052")},
		"Prioritario": {Estado: "Disponible", Cliente: s.connectCaravana("dist039:50052")},
		"Normal":      {Estado: "Disponible", Cliente: s.connectCaravana("dist039:50052")},
	}
}
